...
K:"ytp-mdx-popup-dialog",U:{role:"dialog"},S:[{D:"div",K:"ytp-mdx-popup-dialog-inner-content",S:[{D:"div",K:"ytp-mdx-popup-title",oa:"Saliste de tu cuenta"},{D:"div",K:"ytp-mdx-popup-description",oa:"Es posible que los videos que mires se agreguen al historial de reproducciones de la TV, lo que puede influir en las recomendaciones. Para que esto no suceda, presiona \u201cCancelar\u201d y accede a YouTube desde tu computadora."},{D:"div",K:"ytp-mdx-privacy-popup-buttons",S:[{D:"button",Ca:["ytp-button",
"ytp-mdx-privacy-popup-cancel"],oa:"Cancelar"},{D:"button",Ca:["ytp-button","ytp-mdx-privacy-popup-confirm"],oa:"Confirmar"}]}]}]});this.i=new g.xK(this,250);this.cancelButton=this.Ba("ytp-mdx-privacy-popup-cancel");this.confirmButton=this.Ba("ytp-mdx-privacy-popup-confirm");g.G(this,this.i);this.N(this.cancelButton,"click",this.l);this.N(this.confirmButton,"click",this.u)},H7=function(a){g.V.call(this,{D:"div",
...
b=g.T(b,128)?g.xH("Error en $RECEIVER_NAME",c):b.wc()||g.T(b,4)?g.xH("Reproduciendo en $RECEIVER_NAME",c):g.xH("Conectado a $RECEIVER_NAME",c);a.Ra("statustext",b);a.i.show()}else a.i.hide()},I7=function(a,b){g.UO.call(this,"Reproducir en",0,a,b);
...
I7.prototype.ni=function(a){return"cast-selector-receiver"===a?"Transmitir\u2026":this.Lm[a].name};
